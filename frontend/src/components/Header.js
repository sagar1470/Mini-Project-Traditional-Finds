...
<nav className={`fixed @apply top-0 shadow-md left-0 w-full z-50 transition-transform duration-300 ${
  isVisible ? "translate-y-0" : "-translate-y-full"
}`}>
  <div className={`bg-white/90 backdrop-blur-md border-b transition-all ${
    isAtTop ? "border-transparent" : "border-gray-200"
  }`}>
    <div className="">
      <div className="flex items-center justify-between h-16">
        {/* Your Navbar Content */}
       
        <header className='h-16 shadow-md bg-gradient-to-r from-amber-50 to-amber-100 fixed w-full z-40 border-b border-amber-200'>
  <div className='h-full container mx-auto flex items-center px-4 justify-between'>
    ...
    <div className='flex items-center md:gap-6 gap-3'>
      ...
      {/* Cart */}
      <div className="flex items-center space-x-2 hover:bg-amber-50 px-3 py-1.5 rounded-xl transition-colors group relative">
        <div className="relative">
